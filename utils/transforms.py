...
class AddNoise(object):
    ...
    def __call__(self, data):
        ...
        data['pcl_noisy_L1'] = data['pcl_clean'] + torch.randn_like(data['pcl_clean']) * self.noise_std_min
        data['pcl_noisy_L2'] = data['pcl_clean'] + torch.randn_like(data['pcl_clean']) * self.noise_std_max
...
class RandomScale(object):
    ...
    def __call__(self, data):
        ...
        if 'pcl_noisy' in data:
            ...
            data['pcl_noisy_L1'] = data['pcl_noisy_L1'] * scale
            data['pcl_noisy_L2'] = data['pcl_noisy_L2'] * scale
        return data
...
class RandomRotate(object):
    ...
    def __call__(self, data):
        ...
        if 'pcl_noisy' in data:
            ...
            data['pcl_noisy_L1'] = torch.matmul(data['pcl_noisy_L1'], matrix)
            data['pcl_noisy_L2'] = torch.matmul(data['pcl_noisy_L2'], matrix)
